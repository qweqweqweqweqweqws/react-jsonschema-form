...
import { ThemeProps } from "@spectrumrjsf1/core";
 ...
 */
const Mui4FormWrapper = React.forwardRef(function Mui4TagName(
  props: Omit<PropsWithChildren<HTMLFormElement>, "contentEditable">,
    ...
    <MuiComponentContext.Provider value={MaterialUIContext || {}}>
      <FormTag ref={ref} {...rest}>
        {MaterialUIContext ? (
          ...
          <div>
            WARNING: @material-ui/core or @material-ui/icons is not available
          </div>
        )}
      </FormTag>
