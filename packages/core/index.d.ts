// Originally from https://github.com/DefinitelyTyped/DefinitelyTyped/blob/master/types/@spectrumrjsf1/core/index.d.ts

declare module "@spectrumrjsf1/core" {
  ...
  export type UiSchema = {
    ...
    "ui:ObjectFieldTemplate"?: React.FunctionComponent<
  ...
  export type IdSchema<T = any> = { [key in keyof T]: IdSchema<T[key]> } &
    FieldId;
  ...
  export type PathSchema<T = any> = { [key in keyof T]: PathSchema<T[key]> } &
    FieldPath;
  ...
  export type Widget =
    | React.FunctionComponent<WidgetProps>
  ...
  export namespace utils {
    ...
    export function getSubmitButtonOptions(
      uiSchema: UiSchema
    ...
    export function toConstant(
      schema: JSONSchema7
    ): JSONSchema7Type | JSONSchema7["const"];
...
declare module "@spectrumrjsf1/core/lib/components/fields/SchemaField" {
...
declare module "@spectrumrjsf1/core/lib/components/fields/ObjectField" {
...
declare module "@spectrumrjsf1/core/lib/validate" {
  import { JSONSchema7Definition } from "json-schema";
  import { AjvError, ErrorSchema, FormProps } from "@spectrumrjsf1/core";
